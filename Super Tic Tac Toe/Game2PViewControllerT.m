...
@interface Game2PViewControllerT ()

@end

@implementation Game2PViewControllerT
...
- (void)viewDidLoad
{
    ...
    [self.view addSubview:gameSelect];
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        offset = 15;
        offset2 = 75;
        sizeoffset = 150;
...
-(IBAction)m1 {
    timeLeft1m = 1;
    timeLeft2m = 1;
    timeLabel1.text = @"1:00";
    timeLabel2.text = @"1:00";
    timer1 = [NSTimer scheduledTimerWithTimeInterval:1
                                              target:self
                                            selector:@selector(count1)
                                            userInfo:nil
                                             repeats:YES];
    [gameSelect removeFromSuperview];
}
-(IBAction)m5 {
    timeLeft1m = 2;
    timeLeft2m = 2;
    timeLabel1.text = @"2:00";
    timeLabel2.text = @"2:00";
    timer1 = [NSTimer scheduledTimerWithTimeInterval:1
                                              target:self
                                            selector:@selector(count1)
                                            userInfo:nil
...
-(IBAction)m10 {
    timeLeft1m = 5;
    timeLeft2m = 5;
    timeLabel1.text = @"5:00";
    timeLabel2.text = @"5:00";
    timer1 = [NSTimer scheduledTimerWithTimeInterval:1
                                              target:self
                                            selector:@selector(count1)
                                            userInfo:nil
...
-(IBAction)m20 {
    timeLeft1m = 10;
    timeLeft2m = 10;
    timeLabel1.text = @"10:00";
    timeLabel2.text = @"10:00";
    timer1 = [NSTimer scheduledTimerWithTimeInterval:1
                                              target:self
                                            selector:@selector(count1)
                                            userInfo:nil
...
- (void)count1{
    timeLeft1s = timeLeft1s - 1;
    if (timeLeft1s < 0) {
        if (timeLeft1m > 0) {
        timeLeft1m = timeLeft1m - 1;
        timeLeft1s = timeLeft1s + 60;
        } else {
            [timer1 invalidate];
            gameWon = 2;
    ...
    timeLabel1.text = [NSString stringWithFormat:(@"%.0f:%.0f"), timeLeft1m, timeLeft1s];
}
- (void)count2{
    timeLeft2s = timeLeft2s - 1;
    if (timeLeft2s < 0) {
        if (timeLeft2m > 0) {
            timeLeft2m = timeLeft2m - 1;
            timeLeft2s = timeLeft2s + 60;
        } else {
            [timer2 invalidate];
            gameWon = 1;
            [self.view addSubview:gameOver];
    ...
    timeLabel2.text = [NSString stringWithFormat:(@"%.0f:%.0f"), timeLeft2m, timeLeft2s];
}
...
- (void)buttonPress:(UIButton*)button {
    ...
    if (turn == 0) {
        UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(button.center.x - offset, button.center.y - offset, button.frame.size.width, button.frame.size.height)];
        ...
        if (awin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(a5.center.x - offset2, a5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (bwin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(b5.center.x - offset2, b5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (bwin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(b5.center.x - offset2, b5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (cwin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(c5.center.x - offset2, c5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (cwin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(c5.center.x - offset2, c5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (dwin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(d5.center.x - offset2, d5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (dwin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(d5.center.x - offset2, d5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (ewin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(e5.center.x - offset2, e5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (ewin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(e5.center.x - offset2, e5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (fwin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(f5.center.x - offset2, f5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (fwin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(f5.center.x - offset2, f5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (gwin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(g5.center.x - offset2, g5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (gwin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(g5.center.x - offset2, g5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (hwin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(h5.center.x - offset2, h5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (hwin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(h5.center.x - offset2, h5.center.y - offset2, sizeoffset, sizeoffset)];
        ...
        if (iwin == 1) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(i5.center.x - offset2, i5.center.y - offset2, sizeoffset, sizeoffset)];
            image0.image=[UIImage imageNamed:@"x2.png"];
            [self.view addSubview:image0];
        } else if (iwin == 2) {
            UIImageView *image0 =[[UIImageView alloc] initWithFrame:CGRectMake(i5.center.x - offset2, i5.center.y - offset2, sizeoffset, sizeoffset)];
    ...
    for (UIButton* btn in all) {
        ...
        if ((awin == 1) && (bwin == 1) && (cwin == 1)) gameWon = 1;
        if ((awin == 1) && (dwin == 1) && (gwin == 1)) gameWon = 1;
        if ((awin == 1) && (ewin == 1) && (iwin == 1)) gameWon = 1;
        if ((bwin == 1) && (ewin == 1) && (hwin == 1)) gameWon = 1;
        if ((cwin == 1) && (fwin == 1) && (iwin == 1)) gameWon = 1;
        if ((dwin == 1) && (ewin == 1) && (fwin == 1)) gameWon = 1;
        if ((gwin == 1) && (hwin == 1) && (iwin == 1)) gameWon = 1;
        if ((cwin == 1) && (ewin == 1) && (gwin == 1)) gameWon = 1;
        
        if ((awin == 2) && (bwin == 2) && (cwin == 2)) gameWon = 2;
        if ((awin == 2) && (dwin == 2) && (gwin == 2)) gameWon = 2;
        if ((awin == 2) && (ewin == 2) && (iwin == 2)) gameWon = 2;
        if ((bwin == 2) && (ewin == 2) && (hwin == 2)) gameWon = 2;
        if ((cwin == 2) && (fwin == 2) && (iwin == 2)) gameWon = 2;
        if ((dwin == 2) && (ewin == 2) && (fwin == 2)) gameWon = 2;
        if ((gwin == 2) && (hwin == 2) && (iwin == 2)) gameWon = 2;
        if ((cwin == 2) && (ewin == 2) && (gwin == 2)) gameWon = 2;
